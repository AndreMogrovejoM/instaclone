    ...
    return (
        <div className="post">
            <div className="post__header">
                ...
                {
                    ( user && (username === auth.currentUser.displayName || auth.currentUser.email === "admin@gmail.com") )
                    &&
            ...
            <div className="post__imgcontainer">
                ...
                (imgUrl.includes(".mp4")) || (imgUrl.includes(".MP4")) || (imgUrl.includes(".mov")) || (imgUrl.includes(".MOV")) 
                ? 
                    (
                ...
                {comments.map((comment) => (
                    ...
                    <div className="comment_container">
                        ...
                        <div className="delete__CommentButton" >
                            {
                                ( user && (comment.username === auth.currentUser.displayName || auth.currentUser.email === "admin@gmail.com" ))
                                &&
